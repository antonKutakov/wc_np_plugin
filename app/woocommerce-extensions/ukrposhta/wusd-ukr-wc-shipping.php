...
use WooUkrainianShippingDelivery\App\Controllers\WUSD_UKR_Order_Processing;
...
function wusd_wc_shipping_init(){
    if(!class_exists('WC_WUSD_Woo_Shipping')){
        class WC_UKR_WUSD_Woo_Shipping extends WC_Shipping_Method{
            ...
            public function calculate_shipping($package = array()){
                ...
                $order_processing = new WUSD_UKR_Order_Processing();
