...
function initMap() {
    ...
    jQuery(function ($) {
        $('.wusd_city').on('change', function (e) {
        ...
        google.maps.event.addListener(marker, 'click', (function (marker, i) {
            return function () {
                infowindow.setContent('<h5 id="warehouse_num">' + wh_data[i]['Description'] + '</h5>' +
                    '<div id="warehouse_time">' + '<span class="wusd_open">' + wh_data[i]['Phone'] + '</span>' + '<span class="wusd_close">' + '' + '</span>' + '</div>' + '<div id="warehouse_weight">' + '' + '</div>' + '</div>')
